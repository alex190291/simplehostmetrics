...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NginxProxyhostsBody', function() {
      beforeEach(function() {
        instance = new NginxProxyManagerApi.NginxProxyhostsBody();
      });

      it('should create an instance of NginxProxyhostsBody', function() {
        // TODO: update the code to test NginxProxyhostsBody
        expect(instance).to.be.a(NginxProxyManagerApi.NginxProxyhostsBody);
      });
