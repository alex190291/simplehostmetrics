...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StreamsStreamIDBody', function() {
      beforeEach(function() {
        instance = new NginxProxyManagerApi.StreamsStreamIDBody();
      });

      it('should create an instance of StreamsStreamIDBody', function() {
        // TODO: update the code to test StreamsStreamIDBody
        expect(instance).to.be.a(NginxProxyManagerApi.StreamsStreamIDBody);
      });
