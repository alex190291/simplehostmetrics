...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeadhostsHostIDBody', function() {
      beforeEach(function() {
        instance = new NginxProxyManagerApi.DeadhostsHostIDBody();
      });

      it('should create an instance of DeadhostsHostIDBody', function() {
        // TODO: update the code to test DeadhostsHostIDBody
        expect(instance).to.be.a(NginxProxyManagerApi.DeadhostsHostIDBody);
      });
