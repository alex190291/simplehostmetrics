...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RedirectionhostsHostIDBody', function() {
      beforeEach(function() {
        instance = new NginxProxyManagerApi.RedirectionhostsHostIDBody();
      });

      it('should create an instance of RedirectionhostsHostIDBody', function() {
        // TODO: update the code to test RedirectionhostsHostIDBody
        expect(instance).to.be.a(NginxProxyManagerApi.RedirectionhostsHostIDBody);
      });
