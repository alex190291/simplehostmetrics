...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CertificatesValidateBody', function() {
      beforeEach(function() {
        instance = new NginxProxyManagerApi.CertificatesValidateBody();
      });

      it('should create an instance of CertificatesValidateBody', function() {
        // TODO: update the code to test CertificatesValidateBody
        expect(instance).to.be.a(NginxProxyManagerApi.CertificatesValidateBody);
      });
