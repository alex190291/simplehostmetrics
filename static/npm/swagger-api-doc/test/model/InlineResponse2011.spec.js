...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InlineResponse2011', function() {
      beforeEach(function() {
        instance = new NginxProxyManagerApi.InlineResponse2011();
      });

      it('should create an instance of InlineResponse2011', function() {
        // TODO: update the code to test InlineResponse2011
        expect(instance).to.be.a(NginxProxyManagerApi.InlineResponse2011);
      });
      ...
      it('should have the property accessList (base name: "access_list")', function() {
        // TODO: update the code to test the property accessList
        expect(instance).to.have.property('accessList');
        // expect(instance.accessList).to.be(expectedValueLiteral);
      });
