...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CertIDUploadBody', function() {
      beforeEach(function() {
        instance = new NginxProxyManagerApi.CertIDUploadBody();
      });

      it('should create an instance of CertIDUploadBody', function() {
        // TODO: update the code to test CertIDUploadBody
        expect(instance).to.be.a(NginxProxyManagerApi.CertIDUploadBody);
      });
